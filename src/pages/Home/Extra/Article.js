            ...
            <div className="overflow-hidden">
                <div style={{position: 'relative'}} className="row">
                    ...
                    <div style={{position: 'absolute',top: '50%' ,left: '50%', transform:'translate(-50%,-50%)'}} className="inner w-50 row mx-auto">
                        <div className="col-12 col-lg-6 bg-white p-4 shadow-lg">
                ...
                <div style={{position: 'relative'}} className="row">
                    ...
                    <div style={{position: 'absolute',top: '50%' ,left: '50%', transform:'translate(-50%,-50%)'}} className="inner w-50 row mx-auto">
                        ...
                        <div className="col-12 col-lg-6 bg-white p-4 shadow-lg">
                            ...
                            <p>Most people perceive yoga to be a physical exercise which grants us with numerous healing benefits such as - pliancy, strength, balance, perfect posture, etc. However, don’t be surprised to find out that the science of yoga is much more than just the practice of physical yoga postures; it helps us experience spiritual enrichment and bind us with our true self.</p>
                        </div>
